...
- ① 봇 N판 끝까지(분 분포 · 파산) ② 무작위 손 퍼징(아무 칸 · 대출 · 복권 · 가게 · 파산 · 행성 · 수동 사격 — 걸음마다 돈 · 빚 · 칸 레벨 · 가격 · 구역 검사) ③ 밀린 저장 옮기기 ④ 구역이 끝까지 차례로 열리는가 ⑤ 무한 궤도 ⑥ 파산 10연속 + 다시 불러오기 ⑦ 무한 궤도 60층 ⑧ 가게 소모품 ⑨ 복권 칸 ⑩ 수동 사격.

...
namespace SalvageRun.Orbit.Sim
{
    ...
    public class Market
    {
        ...
        public static readonly NewsDef[] NewsBook =
        {
            ...
            new NewsDef { head = "목성 폭풍 속 선박 실종", body = "목성 대적점 근처에서 화물선 두 척과 연락이 끊겼다.", down = new[] { "jup", "ins" }, size = 0.3f },
            ...
            new NewsDef { head = "궤도 보험, 보험료 인상 승인", body = "파편 사고가 잦아지자 당국이 보험료 인상을 허락했다.", up = new[] { "ins" }, size = 0.16f },
            new NewsDef { head = "무사고 100일 — 보험사 실적 호조", body = "석 달 넘게 큰 충돌이 없었다. 보험사 금고가 두둑하다.", up = new[] { "ins", "kes" }, size = 0.14f },
            new NewsDef { head = "청소선 조선, 선체 결함 리콜", body = "지난해 만든 청소선 절반에서 용접 결함이 나왔다.", down = new[] { "ship" }, size = 0.2f },
            new NewsDef { head = "조선소 노동자 파업", body = "청소선 조선 궤도 조선소가 멈췄다. 임금 협상은 난항.", down = new[] { "ship" }, size = 0.15f },

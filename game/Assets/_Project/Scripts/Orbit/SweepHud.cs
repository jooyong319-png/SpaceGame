...
namespace SalvageRun.Orbit
{
    ...
    public partial class SweepHud : MonoBehaviour
    {
        ...
        void StockSwitch()
        {
            ...
            GUI.Label(new Rect(r.x, r.y + 26, r.width, 18), "<size=10>" + (sim.Mk.TotalValue() > 0 ? (pl >= 0 ? "<color=#ff5c5c>+" : "<color=#5494ff>") + KNum.Fmt(pl) + "</color>" : "<color=#5f6878>S</color>") + "</size>", center);
        ...
        string Val(string id, int l)
        {
            switch (id)
            {
                ...
                case "w_mine": return l > 0 ? (SweepSim.WeaponNode[sim.Weapon] == id ? "장착 중" : "산 것 — 왼쪽 위에서 장착") : "잠김";
                case "w_mine_u": return new[] { "없음", "1단계", "2단계" }[Mathf.Min(2, l)];
                case "w_mine_a": return l > 0 ? "각성!" : "잠김";
                case "w_frz": return l > 0 ? (SweepSim.WeaponNode[sim.Weapon] == id ? "장착 중" : "산 것 — 왼쪽 위에서 장착") : "잠김";
                case "w_frz_u": return new[] { "없음", "1단계", "2단계" }[Mathf.Min(2, l)];
                case "w_frz_a": return l > 0 ? "각성!" : "잠김";
                case "w_clus": return l > 0 ? (SweepSim.WeaponNode[sim.Weapon] == id ? "장착 중" : "산 것 — 왼쪽 위에서 장착") : "잠김";
                case "w_clus_u": return new[] { "없음", "1단계", "2단계" }[Mathf.Min(2, l)];
                case "w_clus_a": return l > 0 ? "각성!" : "잠김";
                case "w_mag": return l > 0 ? (SweepSim.WeaponNode[sim.Weapon] == id ? "장착 중" : "산 것 — 왼쪽 위에서 장착") : "잠김";
                case "w_mag_u": return new[] { "없음", "1단계", "2단계" }[Mathf.Min(2, l)];
                case "w_mag_a": return l > 0 ? "각성!" : "잠김";
                case "w_rail": return l > 0 ? (SweepSim.WeaponNode[sim.Weapon] == id ? "장착 중" : "산 것 — 왼쪽 위에서 장착") : "잠김";
